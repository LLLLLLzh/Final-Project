...
public:
	Inquiry();
	// ctor 
	Inquiry(string _inquiryId, T _product, Side _side, long _quantity, double _price, InquiryState _state);
...
template<typename T>
Inquiry<T>::Inquiry(string _inquiryId, T _product, Side _side, long _quantity, double _price, InquiryState _state) :
  product(_product)
{
